...
interface AboutCoverSectionProps {} //Optional:Define props interface if needed

const AboutCoverSection: React.FC<AboutCoverSectionProps> = () => {
    return(
        <section className='w-full md:h-[75vh] border-b-2 border-solid border-dark dark:border-light flex flex-col md:flex-row items-center justify-center text-dark dark:text-light'>
                  ...
                  <Image
                    ...
                    <p className='ont-medium capitalize mt-4 text-base'>
